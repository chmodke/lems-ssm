...
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/jquery-easyui-1.5.1/plugins/jquery.layout.js" charset="utf-8"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/lems/lems-util.js" charset="UTF-8"></script>
